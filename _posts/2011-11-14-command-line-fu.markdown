...
- xkcd
---
<img src='http://files.ankurs.com/command_line_fu.png' width='100%' />
...
so this is what i came up with, having worked with X bindings before for [Game-on](http://blog.ankurs.com/2010/09/game-on-weekend-project-iii/) this was done in under 5 mins (after reading some docs) , another day saved all thanks to Linux, X11 and previous X11 binding experience :P
